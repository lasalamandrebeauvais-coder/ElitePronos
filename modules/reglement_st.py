...
def afficher_reglement():
    ...
    # Texte NOIR sur fond blanc, blocs auto-ajustes au contenu
    st.markdown("""
    <style>
        /* ===== EXPANDERS STREAMLIT - Ajustement auto ===== */
        ...
        /* Cibler tous les conteneurs parents */
        ...
        /* Paragraphes - NOIR, espacement reduit */
        ...
        /* ===== Boxes de mise en valeur - compactes ===== */
    ...
    with st.expander("ARTICLE 4 : LES JOKERS", expanded=True):
        ...
        <div class="reglement-container" style="background: #FFFFFF !important;">
            ...
            <div class="article-content" style="color: #000000 !important;">
                ...
                <div class="highlight-box" style="border-color: #ff9800 !important; background: rgba(255, 152, 0, 0.1) !important;">
